...
public class Function {
  ...
  private void printParameters(HplsqlParser.Create_procedure_stmtContext ctx, String name) {
     ...
     */
    public void printParam(HplsqlParser.Create_routine_param_itemContext ctx) {
        System.out.println("param");
        if (null != ctx.T_IN() && ctx.T_IN().getText().equals("IN")) {
            System.out.println(ctx.ident().getText() + ":" + ctx.T_IN().getText() + ":" + ctx.dtype().getText());
        }
        if (null != ctx.T_OUT() && ctx.T_OUT().getText().equals("OUT")) {
            System.out.println(ctx.ident().getText() + ":" + ctx.T_OUT().getText() + ":" + ctx.dtype().getText());
        }
    }
